...
namespace aiPonybot {
    ...
    export enum Direction {
        ...
        Clockwise = 1,
        //% blockId="CounterClockwise" block="Counterclockwise"
        CounterClockwise = -1,
    }
    ...
    //% blockId=aiponybot_motor_servo block="|%index| move to angle |%degree|°"
    //% weight=0
    ...
    //% weight=0
    //% blockId=aiponybot_motor_runMotor block="Run |%index| in |%direction| at speed |%speed|"
    //% speed.min=0 speed.max=255
    //% index.fieldEditor="gridpicker" index.fieldOptions.columns=2
    //% direction.fieldEditor="gridpicker" direction.fieldOptions.columns=2
    //% group="Motor(Advanced)"
    ...
    //% weight=0
    //% blockId=aiponybot_motor_runMecanum block="Move ponybot using mecanum |%direction| at speed |%speed|"
    //% speed.min=0 speed.max=255
    ...
    //% weight=0
    //% blockId=aiponybot_motor_stopMotor block="Stop |%index|"
    //% index.fieldEditor="gridpicker" index.fieldOptions.columns=2 
    //% group="Motor(Advanced)"
    ...
    //% weight=20
    //% blockId=aiponybot_motor_stopAllMotors block="Stop all motors"
    //% group="Motor(Basic)"
    ...
    //% weight=0
    //% blockId=aiponybot_motor_runNormal block="Move ponybot |%direction| at speed |%speed|"
    //% speed.min=0 speed.max=255
    //% direction.fieldEditor="gridpicker" direction.fieldOptions.columns=2
    //% group="Motor(Basic)"
    ...
    //% block="both line sensors are %state"
    ...
    //% block="%channel line sensor is %state"
    ...
    //% block="Read value from %channel line sensor"
    //% channel.fieldEditor="gridpicker" channel.fieldOptions.columns=2
    //% group="Line Sensor"
    ...
    class Tcs3472 {
        ...
        rgb(): number[] {
            ...
            for (let index: number = 0; index < result.length; index++) {
                result[index] = result[index] * 255 / clear;
            }
            return result; // [R, G, B]
        }
    ...
    //% block="Set integration time to %time ms"
    ...
    //% block="Is detected color %color (threshold: %threshold)"
 ...
 */
    ...
    //% blockId=aiponybot_display_invert block="Invert display colors %on"
    //% blockGap=8
    ...
    //% blockId=aiponybot_display_clear block="Clear display"
    //% blockGap=8
    //% group="Display Control"
    //% weight=3
    ...
    //% blockId=aiponybot_display_power block="Turn display %on"
    //% on.defl=1
    //% blockGap=8
    //% group="Display Control"
    //% on.shadow="toggleOnOff"
    ...
    //% blockId=aiponybot_display_pixel block="Draw pixel at x: %x y: %y with color: %color"
    //% x.max=127 x.min=0 x.defl=0
    //% y.max=63 y.min=0 y.defl=0
    //% color.max=1 color.min=0 color.defl=1
    //% blockGap=8 inlineInputMode=inline
    //% group="Display (Shapes)"
    //% weight=4
    ...
    //% blockId=aiponybot_display_show_string_xy block="Print text: %text at column: %column row: %row, color: %color"
    //% text.defl='AI ponybot'
    //% column.max=120 column.min=0 column.defl=0
    //% row.max=7 row.min=0 row.defl=0
    //% color.max=1 color.min=0 color.defl=1
    //% blockGap=8 inlineInputMode=inline
    //% group="Display (Text & Numbers)"
    //% weight=1
    ...
    //% blockId=aiponybot_display_show_number_xy block="Print number: %number at column: %column row: %row, color: %color"
    //% number.defl=777
    //% column.max=120 column.min=0 column.defl=0
    //% row.max=7 row.min=0 row.defl=0
    //% color.max=1 color.min=0 color.defl=1
    ...
    //% blockId=aiponybot_display_print_string block="Print text: %text with line break: %newline"
    //% text.defl="AI ponybot"
    //% newline.defl=true
    //% blockGap=8 inlineInputMode=inline
    //% group="Display (Text & Numbers)"
    ...
    //% blockId=aiponybot_display_print_number block="Print number: %number with line break: %newline"
    //% number.defl="777"
    //% newline.defl=true
    ...
    //% blockId=aiponybot_display_hline block="Draw horizontal line at x: %x y: %y length: %length color: %color"
    //% x.max=127 x.min=0 x.defl=0
    //% y.max=63 y.min=0 y.defl=0
    ...
    //% blockId=aiponybot_display_vline block="Draw vertical line at x: %x y: %y length: %length color: %color"
    //% x.max=127 x.min=0 x.defl=0
    //% y.max=63 y.min=0 y.defl=0
    //% length.max=128 length.min=1 length.defl=16
    //% color.max=1 color.min=0 color.defl=1
    ...
    //% blockId=aiponybot_display_rectangle block="Draw rectangle from x1: %x1 y1: %y1 to x2: %x2 y2: %y2 color: %color"
    //% color.defl=1
    //% blockGap=8 inlineInputMode=inline
    //% group="Display (Shapes)"
    //% weight=3
    ...
    //% blockId=aiponybot_uart_parse_unified
    //% block="From UART data %data extract %type as %format"
    //% inlineInputMode=inline
    //% group="AI Data Parsing"
    //% weight=70
    ...
    //% blockId=aiponybot_color_parse_unified
    //% block="From UART data %data extract color %color as %format"
    //% inlineInputMode=inline
    //% group="AI Data Parsing"
    //% weight=69
